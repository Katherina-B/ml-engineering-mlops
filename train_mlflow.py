...
mlflow.set_tracking_uri(f'https://dagshub.com/' + 'katherina.barbasheva'+ '/' + 'mlops' + '.mlflow')
try:
    print("Successfully connected to MLflow on DAGsHub")
except Exception as e:
    print(f"Error connecting to MLflow on DAGsHub: {e}")
